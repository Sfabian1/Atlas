...
async CreateWorkout(req) {
    ...
    try {
      ...
      isValidEnumValue("difficultyEnum", req_body.difficulty,true);
      isValidDateFormat(req_body.date);
      isValidEnumValue("statusEnum", req_body.status,true);
      isValidTimeFormat(req_body.timeStart);
      isValidTimeFormat(req_body.timeEnd);
    ...
    async UpdateWorkout(req) {
        ...
        try {
          ...
          const updates = [];
          isValidEnumValue("difficultyEnum", req_body.difficulty,false);
      isValidDateFormat(req_body.date);
      isValidEnumValue("statusEnum", req_body.status,false);
      isValidTimeFormat(req_body.timeStart);
      isValidTimeFormat(req_body.timeEnd);
